    ...
    public class MagnifyDrawingShape : EllipseDrawingShape
    {
        ...
        public override void OnDraw(Graphics g)
        {
            ...
            using (GraphicsPath gp = new GraphicsPath())
            {
                ...
                var source = Manager.ShotCabEffectSnapshot ?? Manager.Form.Canvas;
                float sourceOffsetX = Manager.ShotCabEffectSnapshot == null ? -Manager.Form.CanvasRectangle.X + Manager.RenderOffset.X : 0;
                float sourceOffsetY = Manager.ShotCabEffectSnapshot == null ? -Manager.Form.CanvasRectangle.Y + Manager.RenderOffset.Y : 0;
                g.DrawImage(source, Rectangle,
                    new RectangleF(Rectangle.X + (Rectangle.Width / 2) - (newWidth / 2) + sourceOffsetX,
                    Rectangle.Y + (Rectangle.Height / 2) - (newHeight / 2) + sourceOffsetY,
