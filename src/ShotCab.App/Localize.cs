...
namespace ShotCab.App
{
    internal static class Localize
    {
        ...
        private static readonly Dictionary<string,string> words = new Dictionary<string,string>
        {
            ...
            ["已选 {0} 张 · 批量操作"]="{0} selected · Actions",["收藏所选"]="Favorite selected",["取消收藏所选"]="Unfavorite selected",["隐藏所选"]="Hide selected",["删除所选到回收站"]="Move selected to recycle bin",["确定将 {0} 张截图移入回收站？"]="Move {0} captures to the recycle bin?",["Ctrl+单击增减选择，Shift+单击选择范围"]="Ctrl+click to toggle; Shift+click for a range",
